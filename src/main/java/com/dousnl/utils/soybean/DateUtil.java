package com.dousnl.utils.soybean;
 ...
 * v1.0.0       2021/8/19       hanliangliang     新增              1001
 ********************************************************************/
public class DateUtil {
    ...
    private static final ThreadLocal<SimpleDateFormat> DEFAULT_DATE_FORMATTER = new ThreadLocal<SimpleDateFormat>() {
        ...
        @Override protected synchronized SimpleDateFormat initialValue() {
    ...
    public static int age(Date birthDay, Date dateToCompare) {
        ...
        if (cal.before(birthDay)) {
            throw new IllegalArgumentException(String.format("Birthday is after date {}!", new Object[]{formatDate(dateToCompare)}));
        } else {
            int year = cal.get(1);
            int month = cal.get(2);
