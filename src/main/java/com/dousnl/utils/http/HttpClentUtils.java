...
public class HttpClentUtils {
	 ...
	 * @throws ClientProtocolException
	 */
	public static Result postJson(String url, Map<String, String> headers, Map<String, Object> params, String encoding) throws ClientProtocolException, IOException {
	...
	public static Result postJson(String url, Map<String, String> headers, String jsonParams, String encoding) throws ClientProtocolException, IOException {
		...
		post.setEntity(new StringEntity(JSON.toJSONString(jsonParams), encoding));
